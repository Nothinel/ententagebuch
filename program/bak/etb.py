...
def scramble_ascii_art(file_name):
    ...
    for char in char_list:
        string.replace(char, random.choice(symbols))
...
def main(stdscr):
    while not password(stdscr):
        display_ascii_art(stdscr, "ascii_art/falsch.txt", duration=1)
    ...
    for i in range(0,10):
        ...
        display_ascii_art(stdscr, "ascii_art/SKU.txt.scrambled", duration=False)
        stdscr.refresh()
        stdscr.clear()
